package com.nerdyturtle.floracraft.client.render;
...
public class RenderCrystalineSpike extends Render{
            ...
            float f, float f1) 
    {
        ...
        this.loadTexture("/mods/floracraft/item/crystalineSpike.png");
        GL11.glPushMatrix();
